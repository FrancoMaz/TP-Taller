...
Servidor* inicializarServidor() {
	...
	if (threadOk != 0){
		...
		servidor->guardarLog("ERROR: No se pudo crear el thread de escucha de conexiones", DEBUG);
	}
	else{
		servidor->guardarLog("Creación de thread de escucha de conexiones OK.", DEBUG);
	}
